...
class FlashDensoCan02 : public QDialog
{
    Q_OBJECT

public:
    explicit FlashDensoCan02(SerialPortActions *serial, FileActions::EcuCalDefStructure *ecuCalDef, QString cmd_type, QWidget *parent = nullptr);
    ~FlashDensoCan02();
...
private:
    ...
    QByteArray subaru_denso_decrypt_32bit_payload(QByteArray buf, uint32_t len, const uint16_t *keytogenerateindex, const uint8_t *indextransformation);
