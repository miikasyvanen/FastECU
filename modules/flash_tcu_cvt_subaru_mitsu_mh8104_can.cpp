...
int FlashTcuCvtSubaruMitsuMH8104Can::init_flash_mitsu_can()
{
    ...
    if (result == STATUS_SUCCESS)
    {
        if (cmd_type == "read")
        {
            ...
            send_log_window_message("Reading ROM from TCU Subaru Hitachi using CAN", true, true);
        ...
        else if (cmd_type == "test_write" || cmd_type == "write")
        {
            ...
            send_log_window_message("Writing ROM to TCU Subaru Hitachi using CAN", true, true);
