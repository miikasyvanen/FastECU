 ...
 * @return
 */
int FlashEcuSubaruDensoSH7058CanDiesel::check_romcrc(const uint8_t *src, uint32_t start, uint32_t len, int *modified)
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
...
int FlashEcuSubaruDensoSH7058CanDiesel::init_flash_write()
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
