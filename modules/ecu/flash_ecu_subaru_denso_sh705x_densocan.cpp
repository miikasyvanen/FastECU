 ...
 * @return
 */
int FlashEcuSubaruDensoSH705xDensoCan::connect_bootloader_start_countdown(int timeout)
{
 ...
 * @return
 */
int FlashEcuSubaruDensoSH705xDensoCan::send_log_window_message(QString message, bool timestamp, bool linefeed)
{
