#ifndef FLASH_ECU_SUBARU_DENSO_SH7XXX_CAN_H
#define FLASH_ECU_SUBARU_DENSO_SH7XXX_CAN_H
...
class FlashEcuSubaruDensoSH7xxxCan : public QDialog
{
    Q_OBJECT

public:
    explicit FlashEcuSubaruDensoSH7xxxCan(SerialPortActions *serial, FileActions::EcuCalDefStructure *ecuCalDef, QString cmd_type, QWidget *parent = nullptr);
    ~FlashEcuSubaruDensoSH7xxxCan();
...
#endif // FLASH_ECU_SUBARU_DENSO_SH7XXX_CAN_H
