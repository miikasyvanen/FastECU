...
void FlashEcuSubaruHitachiM32R_02::closeEvent(QCloseEvent *event)
{
    kill_process = true;
}
 ...
 */
QByteArray FlashEcuSubaruHitachiM32R_02::add_ssm_header(QByteArray output, uint8_t tester_id, uint8_t target_id, bool dec_0x100)
{
 ...
 */
uint8_t FlashEcuSubaruHitachiM32R_02::calculate_checksum(QByteArray output, bool dec_0x100)
{
    uint8_t checksum = 0;
 ...
 * @return
 */
int FlashEcuSubaruHitachiM32R_02::connect_bootloader_start_countdown(int timeout)
{
 ...
 * @return parsed message
 */
QString FlashEcuSubaruHitachiM32R_02::parse_message_to_hex(QByteArray received)
{
    QString msg;
 ...
 * @return
 */
int FlashEcuSubaruHitachiM32R_02::send_log_window_message(QString message, bool timestamp, bool linefeed)
{
...
void FlashEcuSubaruHitachiM32R_02::set_progressbar_value(int value)
{
    if (ui->progressbar)
...
void FlashEcuSubaruHitachiM32R_02::delay(int timeout)
{
