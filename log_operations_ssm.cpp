...
/*
    ...
    qDebug() << "0x01 response:" << parse_message_to_hex(received);
    ...
    delay(200);
    received = serial->read_serial_data(100, 500);
    qDebug() << "0x10 0x03 response:" << parse_message_to_hex(received);
    ...
    delay(200);
    received = serial->read_serial_data(100, 500);
    qDebug() << "0x10 0x43 response:" << parse_message_to_hex(received);
*/
...
*/
    received = serial->read_serial_data(100, 500);
    //qDebug() << "CAN response:" << parse_message_to_hex(received);
}
